...
3. Include key data points in your recommendations: resort name, region, total piste length, vertical drop, distance from home, and travel duration.
4. Explain why each resort matches their preferences, using specific data from the database.
5. Suggest any adjustments to trip dates for a better experience (e.g., based on altitude for snow conditions).
6. Provide tips for each resort (best runs, facilities, etc.).
7. Include transport recommendations based on their preferred mode of transport ({transport}).
